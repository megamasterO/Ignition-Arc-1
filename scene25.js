...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/classicSwing.mp3", id: "bgmusic" },
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",        "The next day",,"orphanage"],
        [narrator,"",        "person1: We need to keep the riff raff off the streets. It's not good for business",,"orphanage"],
        [narrator,"",        "person2: He only needs some guidance. Don't worry the church will take him in",,"orphanage"],
        [narrator,"",        "person1: Alright, well are we in agreeance Mr Rice?",,"orphanage"],
        [narrator,"",        "Mr. Rice: Yes sir",,"orphanage"],
        [narrator,"",        "Guests leave the orphanage",,"orphanage"],
        [rice,,     "It looks like I was able to come up with the bail","enter1",],
        [rice,,     "I'm not happy with the method but it's the end result that matters right?",,"orphanage"],
        [elijah,,         "Will I ever get out of here??","enter2","bgJailCell"],
        [rice,,     "Hey Elijah, you're good to go",,],
        [rice,,     "Come with me",,],
        [elijah,,         "...",,"bgCarInterior"],
        [elijah,,         "I'm sorry",],
        [elijah,,         "I won't cause any more trouble for you",],
        [rice,,     "I know you won't because you're grounded",],
        [rice,,     "...but I'm happy to have you back",],
        [rice,,     "...",],
        [rice,,     "while we're talking, I have something important to tell you",],
        [rice,,     "You're one of the oldest kids at the orphanage now",],
        [rice,,     "But like I mentioned before, there's a family interested in adopting!",],
        [elijah,"",          "What's that go to do with me?",,],
        [rice,,     "It's you Eli!",],
        [elijah,"",          "...",,],
        [rice,"",            "Eli?",,],
        [elijah,"",          "Oh... you were serious before",],
        [elijah,"",          "Do I have a say?",],
        [rice,,     "Well they'll be by so you can meet them",],
        [elijah,"",          "When would they adopt me?",,],
        [rice,,     "It's still a few months out",],
        [elijah,"",          "^So there's still a chance for me to win this race and get out of here^",,],
        [elijah,"",          "^I've got to get right to work^",,],
        [rice,,     "I know change can be scary but really it's a good thing to find a family!",],
        [rice,,     " ","exit"],
        [elijah,"",        "The screen pans to show what Elijah had etched onto the wall","exit","bgJailCell"],
        [narrator,"",        "It's a blueprint and list of all the components needed to make a booster board",,],
        [engineer,,     "Well done boy...","enter1"],
        //The screen pans to show what Elijah had etched onto the wall
        //It's a blueprint/list of all the components needed to make a booster board

        
        [narrator,"",        "SCENE END",,],
        [engineer,"",        "*Click to Restart*","exit",],
        //scene ends   
    ];
