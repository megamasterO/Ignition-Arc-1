...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/suzzane.png", id: "suzzane" },
        { src: "images/greg.png", id: "greg" },
        ...
        { src: "sounds/orchestrasmooth.mp3", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    Object.assign(atlas, {
        ...
        'suzzane': {
            default: generateCharacter("suzzane", 0, 0, 1, 1, 0, 0, 0),
        },
        'greg': {
            default: generateCharacter("greg", 0, 0, 1, 1, 0, 0, 0),
        },
        'knight': {
            default: {
                bitmap: knight,
...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",       "*Elijah stumbles up stairs to his shared room*","enter1","orphanage"],
        [elijah,"",       "*opens door with a creak*",,],
        [rice,"",         "Elijah I thought I told you to pack!","enter2",],
        [rice,"",         "There going to be here any moment now",,],
        [rice,"",         "Mr. Rice is frantically packing all of Elijah's things into a duffel bag",,],
        [elijah,"",       "What- what's going on?",,],
        [elijah,"",       "My stuff...what are you doing??",,],
        [rice,"",         "Suzzane and Greg. Their picking you up today!",,],
        [rice,"",         "*fustrated sigh* Elijah sometimes you can be so forgetful",,],
        [elijah,"",       "no I",,],
        [elijah,"",       "I just ^crap where did the time go!?^",,],
        [elijah,"",       "I just thought I had more time!",,],
        [narrator,"",     "*ding dong*",,],
        [narrator,"",     "*ding dong*",,],
        [rice,"",         "Ah! That's them! Elijah hurry. Finish packing while I go grab them",,],
        [rice,"",         "*Mr. Rice leaves to go answer the door*","exit",],
        [narrator,"",     "*Elijah stands there stunned*",,],
        [suzzane,"",      "Whooo's ready to become a Hertzel","enter2",],
        [greg,"",         "In the Hertzel family we always greet with a family hug","enter4",],
        [narrator,"",     "The couple wraps their arms around Elijah",,],
        [rice,"",         "Alright Elijah, grab the rest of your things","enter3",],
        [elijah,"",       "No",,],
        [rice,"",         "Elijah, what did we talk about",,],
        [elijah,"",       "No you can't make me",,],
        [elijah,"",       "Pleaseee. Aren't I helpful around here?",,],
        [elijah,"",       "I do most of the cooking. I do cleaning too",,],
        [elijah,"",       "I'm needed here. Please you can't make me go",,],
        [elijah,"",       "I don't want to go",,],
        [elijah,"",       "I ... *chokes on his words. Tears are streaming down his face*",,],
        [rice,"",         "You are loved here, but you have a new loving family",,],
        [rice,"",         "...It's- it's for the best",,],
        [greg,"",         "Alright champ come on *Slings Elijah over his shoulders*",,],
        [greg,"",         "Don't cry. Us guys don't cry. Were gonna get you some hotdogs and icecream on the way over",,],
        [elijah,"",       "Nooooooo I don't want to go",,],
        [greg,"",         "Hey honey can you grab his bag",,],
        [elijah,"",       "Please I'll do anything... I'll be good. I have been good!!",,],
        [rice,"",         "*Mr. Rice and Elijah make eye contact and Mr. Rice feels bad*",,],
        [greg,"",         "*Greg Hertzel and Elijah exit the room","exit",],
        [elijah,"",       " ","exit",],
        [rice,"",         "Here take these *hands Suzzane Electric Lady and Atomic Gentle action figure",,],
        [suzzane,"",      "We don't need things like this in our house *she says in disgust*",,],
        [rice,"",         "Please just take it",,],
        [suzzane,"",      "*Suzanne stuffs action figures in bag and leaves*","exit",],
        [narrator,"",     "Mr. Rice watches as the couple pull away in the car",,"bgOrphanageOutside"],
        [rice,"",        "SCENE END","exit",],
