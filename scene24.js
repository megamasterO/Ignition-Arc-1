...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",          "That's right I have this pamphlet from grayson's sporting store - build your own custom jet board -","enter1","bgJailCell"],
        [elijah,"",          "*flips to first page*",,],
        [narrator,"",        "Are you tired of being in the dumps?",,],
        [narrator,"",        "Do you feel like you're just not special?",,],
        [narrator,"",        "Do you want to make your own booster board?",,],
        [elijah,"",          "*nods in agreement at all the questions*",,],
        [narrator,"",        "Does your name start with E?",,],
        [elijah,"",          "*Gasp* how did they know??",,],
        [narrator,"",        "Then look no further because we have all the juicy details inside!",,],
        [narrator,"",        "The first step is to envision what you want this board to look like. How it will function and handle.",,],
        [narrator,"",        "Okay now that you've got a clear picture… look at this catalog and put a check mark next to everything you would like and seal it with an envelope with a cash check along with it.",,],
        [narrator,"",        "We'll handle the rest once we have all your money.",,],
        [elijah,"",          "...",,],
        [elijah,"",          "You got to be kidding me!?",,],
        [elijah,"",          "There was no mention of how to do any building",,],
        [elijah,"",          "Let alone how incredibly expensive everything was",,],
        [elijah,"",          "*Chucks pamphlet on the ground and bangs ahead against wall*",,],
        [engineer,,          "what's wrong buddy. You know what they say. When you back is against the wall... uh ... turn around and climb it?","enter2"],
        [elijah,,         "Hmmm...",],
        [narrator,"",        "Elijah starts scraping the wall with a rock. It looks like he's just mad",,],
        [elijah,,         "SKKREEEEEE",],
        [engineer,,     "... Or scratch it. That works too I guess. These wise guys don't know everything",],
        [engineer,,     " ","exit"],
