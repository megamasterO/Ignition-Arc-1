...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgCarInterior"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [rice,"",	       "You're not causing any trouble at school, are you?",,],
        [elijah,,         	"...just doing my classes and sticking to myself",,],
        [rice,"",	       "I know school has been tough for you. But it's gonna get better",,],
        [rice,"",	       "I remember I was a little awkward and had trouble fitting in",,],
        [elijah,,         	"I think I'm pass trying to fit in",,],
        [rice,"",	       "Well I'm just saying that I used to get teased, bullied even",,],
        [rice,"",	       "But you have to pick and choose your battles",,],
        [rice,"",	       "Because it does get better, I promise",,],
        [rice,"",	       "Alsoooo I have something in the works that I think you might like",,],
        [elijah,,         	 "uh huh",,],
        [narrator,"",        "Mr. Rice and Elijah pull up to the local library",,],
        [rice,"",	       "Well we're here",,],
        [rice,"",	       "I'm proud of you still working hard in school",,],
        [narrator,"",        "*Elijah grabs his bag and hops out of the auto*",,],
        [rice,"",	       "Oh and don't forget to come back before dinner!",,],
        [rice,"",	       " ","exit",],
        [narrator,"",        "*Mr. Rice putters away in his old auto*",,],
        [elijah,,         	 "Now where were we...",,],
        [elijah,,         	 "That's right, off to the port!",,],
        [narrator,"",        "SCENE END",,],
