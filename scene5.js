...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/bathroomstall.png", id: "bgimage" },
...
function scriptReader() {
    ...
    var textBlocks = [
        //fade in
        [narrator,"",          "*Janitor leaves and door closes*",,"bgimage"],
        [elijah,"",            "Alright, does everyone understand the plan?","enter1",],
        [narrator,"",          "Doesn't this kid know we are inanimate objects?",,],
        [elijah,"",            "*peaks head left and right out of the stall*",,],
        [elijah,"",            "OK mission is a go!",,],
        [elijah,"",            "*tip toes out of bathroom stall*",,],
        //show shadowy figure zipping past window
        [elijah,"",            " ",,"gif1"],
        [elijah,"",            "What was that??",,],
        [elijah,"",            "           ...",,],
        [elijah,"",            "Must have been my imagination",,],
        [elijah,"",            "Alright, I'll just set you here",,"bgHallway"],
        [elijah,"",            "And everything is setup. It's go time",,"bgBathroom"],
        [narrator,"",          "VrrrrRRRRRRR",,],
        [elijah,"",            "Ok really, what is that??",,],
        [elijah,"",            "*rushes to bathroom window",,],
        [elijah,"",            "*looks left and right*",,],
        [elijah,"",            "hmmm... nothing",,],
        [elijah,"",            "Well, on with the plan!",,],
        //plays out the animation that I've already created of him breaking into the Principal's office
        //However some major changes
        [elijah,"",            "",,"gif2"],
