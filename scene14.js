...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgRaining"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",            "...I don't want to live here anymore","enter1",],
        [narrator,"",          "A couple of kids in the older grade stumble out of the conveniet store",,],
        [willy,"",              "I'm gonna get the best booster board out there so I can crush the competition.","enter2",],
        [bret,"",             "My mom will buy me anything if I complain enough haha. What should we do with the money once we win?","enter4",],
        [willy,"",              "I don't know about you but I'm thinking some fresh threads. This jacket's like a month old and my parents won't take me shopping.",,],
        [willy,"",              "They say I have too many jackets that it's taking up their closet space. The nerve. They don't understand we've got to be the freshest on the block, bro.",,],
        [willy,"",              " ","exit",],
        [bret,"",              " ","exit",],
        [elijah,"",            "Freshest on the block brooo *in a mocking tone*",,],
        [elijah,"",            "If only I could get my hands on one of those things...",,],
        [narrator,"",          "*kicks can across street*",,],
        [elijah,"",            "Come on Elijah, think...",,],
        [elijah,"",            "Maybe I could make it?",,],
        [elijah,"",            "Who am I kidding. Duct taping a mop and soccer ball to a remote control car is NOT the same as building a jet board.",,],
        [elijah,"",            "It's literally ROCKET SCIENCE",,],
        [elijah,"",            "...",,],
        [elijah,"",            "!",,],
        [elijah,"",            "I may not be able to make it but Commander Chaos always has something up his sleeves",,],
        [elijah,"",            "hehe. Hahaha. MWAHAHAHAHAAHA!",,],
        [narrator,"",          "SCENE END",,],
