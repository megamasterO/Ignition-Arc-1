...
function scriptReader() {
    ...
    var textBlocks = [
        //We see him in the spot he likes to go to when he wants to be left alone
        [elijah,,         "Elijah is huddled on the edge of the basketball court overlooking the rest of the town","enter1","bgBasketballCourt"],
        [elijah,,         "Thas naht pahsible!",],
        [elijah,,         "I know I did it right",],
        [elijah,,         "*takes another look at the test*",],
        [elijah,,         "These numbers. They were different last time",],
        //Elijah grips test in one hand and bites down the corner and rips the test in half
        //tears test piece by piece in frustration
        [elijah,,         "*Elijah grips test in one hand and bites down the corner and rips the test in half*",],
        [elijah,,         "*tears test piece by piece in frustration*",],
        [elijah,,         "I'm not-",],
        [elijah,,         "I'm not stupid!",],
        //Elijah grips shredded test in his hands
        //A few tears are rolling down his face but he's trying his best to hold back
        //A little while later
        [elijah,,         "*grips shredded test in his hands*",],
        [elijah,,         "*A few tears are rolling down his face but he's trying his best to hold back*",],
        [narrator,"",        "A little while later",,],
        //Mr. Rice sits beside him on the edge(determine the actual location)
        [rice,,         "*Mr. Rice sits beside him on the edge*","enter2"],
        [rice,,         "Here you are","enter2"],
        [rice,,         "The office called me again",],
        [rice,,         "Said you left school",],
        [rice,,         "Do you want to say something?",],
        [elijah,,         "no",],
        [rice,,         "Did something happen?",],
        [elijah,,         "no",],
        [rice,,         "Well, I'm not gonna leave until you tell me what happened",],
        [rice,,         "So you can tell me now, or wait until later",],
        [elijah,,         "Fine. *grumbles* I failed that stupid test",],
        [rice,,         "Oh...",],
        [rice,,         "Listen, I understand how you feel...",],
        [rice,,         "A stupid test doesn't make a person stupid",],
        [rice,,         "Eli, I don't need a test to know how smart you are",],
        [rice,,         "Is this the test?",],
        [rice,,         "*Mr. Rice points to Elijah's clenched hand*",],
        [rice,,         "takes pieces of shredded test and releases it into the air",],
        //Mr. Rice points to Elijah's clenched hand
        //takes pieces of shredded test and releases it into the air
        //the two sit together for a minute
        [narrator,"",        "the two sit together for a minute",,],
        [rice,,         "...Do you want to go to Burger Bills?",],
        [elijah,,         "But I failed the test",],
        [rice,,         "Just this one time",],
        [elijah,,         "You mean it?",],
        [rice,,         "Yup, I have something to give you",],
        [rice,,         "Plus you playing hooky this early makes it lunch time",],
        //Mr. Rice looks over and smiles
        [rice,"",        "Mr. Rice looks over and smiles",,],
