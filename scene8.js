...
function scriptReader() {
    ...
    var textBlocks = [
        [rice,"",	          "No... we can't afford a booster board right now","enter2",],
        [elijah,"",            "What do you mean!?","enter1",],
        [elijah,"",            "All the other kids are getting one",,],
        [elijah,"",            "You're always telling me that I need to get involved in something...to do something constructive",,],
        [rice,"",	          "What about joining the baseball team? I did that when I was your age",,],
        [rice,"",	          "Also, how's school going? You making friends?",,],
        [elijah,"",            "School's dumb! I hate it",,],
        [rice,"",	          "Now Elijah, don't say that",,],
        [rice,"",	          "Don't you want to grow up with a good education and having friends?",,],
        [elijah,"",            "NO! I don't want to grow up to be a boring adult!",,],
        [elijah,"",            "Why can't I fly like the other kids? . . . . . . I never get anything I want",,],
        [rice,"",	          ". . . I'm sorry Elijah, but the answer is no",,],
        [rice,"",	          "We just don't have the money",,],
        [elijah,"",            "Fine! I'll just get it myself then","exit",],
        [rice,"",             "Elijah wait...",,],
        [rice,"",	          "*Sigh* he's already gone",,],
