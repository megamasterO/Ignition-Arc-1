...
function scriptReader() {
    ...
    var textBlocks = [
        //Elijah grips key and we sink into a flashback
        //[2 weeks prior to story beginning]
        //Elijah is seen lying on the ground reading his comics (or maybe playing with his action figures)
        //knock knock
        [narrator,"",        "2 weeks prior to us beginning the story a simple but profound catalyst occurs",,"orphanage"],
        [elijah,"",        "Elijah is seen lying on the ground reading his comics","enter1",],
        [narrator,"",        "*knock knock*",,],
        [rice,,         "Hey Elijah, mind if I come in","enter2"],
        [elijah,,         "Sure, whatever",],
        //Mr. Rice steps into the room with first aid kit
        [narrator,"",        "Mr. Rice steps into the room with first aid kit",,],
        [rice,,         "Let me see your face",],
        //Elijah face is bruised and cut
        [narrator,"",        "Elijah face is bruised and cut",,],
        [rice,,         "Sigh* Come here",],
        //Mr. Rice picks up Elijah and puts him on dresser
        [narrator,"",        "Mr. Rice picks up Elijah and puts him on dresser",,],
        [rice,,         "Do you know what next week is?",],
        [elijah,,         "...",],
        //Mr. Rice applies first aid bandage
        [narrator,"",        "Mr. Rice applies first aid bandage",,],
        [rice,,         "It's your birthday",],
        [elijah,,         "Oh...who cares...",],
        [rice,,         "Would you if I told you I'm taking you to Burger Bills?",],
        [elijah,,         "Burger Bills!!?",],
        [rice,,         "Yes. But there's a catch...",],
        [rice,,         "Your teacher informed me you have a math test coming up. I'll ONLY take you IF you get a B or higher",],
        [elijah,,         "Really!!? We've never gone there before",],
        [rice,,         "And we won't if you don't pull up those grades *smile",],
        [elijah,,         "I got it",],
        //Mr. Rice exits the room
        [rice,"",        "Mr. Rice exits the room","exit",],
        [elijah,,         "You hear that Atomic Gentle!",],
        //grabs action figure
        //it’s taped up from when it was previously destroyed
        [elijah,"",        "*grabs action figure*",,],
        [elijah,"",        "*it's taped up from when it was previously destroyed*",,],
        [elijah,,         "Burgers and fries until they come out our nose",],
        [elijah,,         "Now where did I put that homework and study guide?",],
        [elijah,,         "I got lots of catching up to do",],
        //Elijah sits his action figures around him and pretends he is teaching them as he studying for his upcoming test
        //more timelapse shots of him working up to the day of the test
        //then one night Elijah cracks open the door to Mr. Rice’s office
        [elijah,"",        "Elijah sits his action figures around him and pretends he is teaching them as he studying for his upcoming test",,],
        [elijah,"",        "more timelapse shots of him working up to the day of the test",,],
        [narrator,"",        "then one night Elijah cracks open the door to Mr. Rice's office",,],
        [elijah,,         "Can you test me?",],
        [rice,,         "Sure, only for a little bit though. What's 6x7?","enter2"],
        ...
        [elijah,,         "mmm...408?",],
        [rice,,         "Wow, very good!",],
        //testing continues and scene fades out
        [rice,"",        "testing continues and scene fades out","exit",],
