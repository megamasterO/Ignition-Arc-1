...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,,     "Later on that evening",],
        [elijah,"",          "*throws baseball against wall and plays catch with himself*","enter1",],
        [mindy,,     "Psst! Hey I brought your comics","enter2"],
        [narrator,,     "*Mindy has climbed up to the holding cell window. She hands comics to Elijah*",],
        [elijah,"",          "*Grabs them and stares at the titles*",,],
        [mindy,,     "*Mindy turns to leave*","exit"],
        [elijah,"",          "*takes the comics and tosses them to the side*",,],
        [narrator,,     "Elijah goes back to tossing baseball against the wall",],
        [elijah,"",          "*looks over at the comics*",,],
        [narrator,,     "The title reads - Electric Lady and Atomic Gentle -",],
        [narrator,,     "- A hero never gives up -",],
        [elijah,"",          "Maybe... but I'm not a hero anyway",,],
        //
        [rice,"",        " ","enter2",],
        [rice,"",        "Hey Elijah, how are you holding up?",,],
        [elijah,"",          "...",,],
        [rice,"",        "Why do you always make things hard for yourself.",,],
        [rice,"",        "You know I'm always here to help you. But I can't keep doing this.",,],
        [rice,"",        "There'll be a time when I won't be able to get you out of a difficult situation...",,],
        [rice,"",        "Do you understand? You need to take responsibility.",,],
        [elijah,"",          "*looks away*",,],
        [rice,"",        "I'm working on getting you out of this",,],
        [rice,,     "Also...",],
        [rice,,     "There's a family looking to adopt you",],
        [rice,,     "We'll talk about it later",],
        [rice,"",        "*let's go of bars and leaves*","exit",],
