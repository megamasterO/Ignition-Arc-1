...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/bathroomstall.png", id: "bg0" },
        ...
        { src: "images/bathroomenter.png", id: "bgimage" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgimage"));
...
function scriptReader() {
    ...
    var textBlocks = [
        //fade in
        [elijah,"",            "*Elijah unbolts vent above toilet*","enter1","bg0"],
        [elijah,"",            "*pulls out what seems like random supplies*",,],
        [elijah,"",            "*you've acquired a mop, soccer ball, tennis ball, a bat, an old sheet, and a set of walkie talkies!*",,],
        [elijah,"",            "Alright guys, so here's the plan",,],
        //cuts to montage of mission impossible style overview
        [elijah,"",            "The objective: let out school for the day",,],
        [elijah,"",            "we'll do this by creating a fake announcement via the loudspeaker in the Principal's office",,],
        [elijah,"",            "How? You say",,],
        [elijah,"",            "Great question mop!",,],
        [elijah,"",            "There's only 1 entrance in to the principal's office",,],
        //background of 1 entrance
        [elijah,"",            "And on top of that there's a second room before the actual Principal's office. A room where the assistants handle absences, doctor's notes, etc",,],
        //assistants interacting with students
        [elijah,"",            "2 sets of doors, assistants expecting me... ",,],
        //where's Elijah at (tapping desk)
        [elijah,"",            "And to top it off, Principal DuPaul will be sitting in his office like he always is. Guarding the microphone that makes announcements",,],
        //principal Dupaul up to some shenanigans
        [elijah,"",            "So we'll need a distraction. In other words Elijah robo 2.0!",,],
        [elijah,"",            "A clone of myself running through the halls surely will catch his attention.",,],
        [elijah,"",            "Once he gives chase I slip in, send the message, and get out",,],
        [elijah,"",            "Easy peasy, lemon squeezy. It may seem, dare I say impossible, but let's not get queasy-",,],
        [narrator,"",          "*SLAM*",,],
        [narrator,"",          "*Door to bathroom bangs open*",,],
        [narrator,"",          "*cleaning cart is wheeled in*",,],
        [elijah,"",            "OH CRAP- *covers mouth with hand*",,],
        [elijah,"",            "And that's right don't let anyone see you",,],
        [elijah,"",            "If anything goes wrong, it's detention again",,],
        [elijah,"",            "And I CAN'T go back",,],
