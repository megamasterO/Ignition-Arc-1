...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/pianochildhoodcomposition.wav", id: "bgmusic" },
...
function scriptReader() {
    ...
    var textBlocks = [
        [greg,"",         "Alright Elijah this is your room","enter1",],
        [elijah,"",       "*Elijah walks forward into room","enter3",],
        [narrator,"",     "The room is plain with only a few scriptures haning on the wall",,],
        [narrator,"",     "The rain is still pouring down outside",,],
        [greg,"",         "OK I'll leave you to get settled in",,],
        [greg,"",         "Greg leaves to go back down stairs","exit",],
        [elijah,"",       "*tosses bag onto bed and climbs in*",,],
        [elijah,"",       "*Mind is still stunned and processing everything that has just happened*",,],
        [elijah,"",       "*Reality sinks in and Elijah is quiet*",,],
        [elijah,"",       "*Sees Electric Lady and Atomic Gentle poking out from the bag*",,],
        [elijah,"",       "*grabs figures and places them on window sill*",,],
        [elijah,"",       "I tried... I really did try",,],
        [elijah,"",       "I'm just not enough",,],
        [narrator,"",        "Memories begin flashing through Elijah's mind",,],
        ...
        [narrator,"",        "-What kind of worthless parents would leave their kid-",,],
        [narrator,"",        "-You're a disruption Elijah!-",,],
        [elijah,"",       "*Once more pulls out mysterious key from shirt and grips it with all his strength*",,],
        [narrator,"",     "Lightning strikes and we are sent tumbling into a flashback",,],
        [rice,"",        "SCENE END","exit",],
