...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/funBeat.wav", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgHallwayOld"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",          "*The next day*",,"bgHallwayOld"],
        [elijahKid,"",            "Just keep to myself","enter1",],
        [brad,,         "Yikes! doesn't Elijah look kind of scary","enter2"],
        [brad,,         "He did something different to his hair",],
        [cody,,         "you think he's part of a gang?","enter4"],
        [brad,,         "Oh yeah I saw that on the news. My parents say it's pretty bad in the city"],
        [zach,,         "I think it looks kind of cool","enter3"],
        //ELijah ignores and walks past them
        [cody,,         "*Elijah ignores them and brushes past","exit"],
        [brad,,        "*mutters* And I think you won't be able to stick pencils in my hair","exit"],
        [zach,,         " ","exit"],
        //classmates disperse
        //zach approaches
        [zach,,         "Hey I'm sorry about those guys","enter2"],
        [zach,,         "they don't know how to chill"],
        [elijahKid,,        "It's whatever..."],
        [zach,,         "Hey do you want to play at recess?"],
        [elijahKid,,        "Do you mean it!"],
        [zach,,         "sure!"],
        [elijahKid,,        "I got this action figure for my birthday last year"],
        [elijahKid,,        "I'll bring it!"],
        //it's recess time at school
        [narrator,"",          " ",,"gif1"],
        [elijahKid,,        "Hey Zach, check out the action figure! This is the only one I have so far",,"schoolPlayground"],
        [zach,,         "Oh that's kind of cool. Looks a lil beat up"],
        [zach,,         "what's it from?"],
        [elijahKid,,        "It's from the best comic ever, “Space Adventures of Electric Lady and The Atomic Gentle”!"],
        [elijahKid,,        "basically a story about these 2 characters named Electric Lady and Atomic gentle as you probably already guessed..."],
        [elijahKid,,        "... and anyways they use these totally cool superpowers to travel through the universe and-"],
        [brad,,         	"Hey, why do you wear the same shirt every day?","enter3"],
        [cody,,         	"Eww and he smells gross","enter4"],
        [zach,,         " ","exit"],
        [brad,,         	"I think that's why he doesn't have a family"],
        [marrow,,         	"Hey! That's enough. We don't talk to other students like that","enter2"],
        [brad,,         	"We're just trying to figure out why he's so weird"],
        [marrow,,         	"Why don't you go play over there"],
        [marrow,,         	" ","exit"],
        //kids start whispering so the marrow doesn't hear
        ...
        //fight ensues
        //Elijah has action figure gripped in hand
        //punches are swung
        //tables are flipped
        //kid 1 has Elijah pinned down
        //Kid 2 unfurls Elijah fists and take his action figure
        [narrator,"",          "*a school brawl erupts on the playground*",,],
        [narrator,"",          "*With a fist still clenching action figure, Elijah takes a swing at the other student*",,],
        [narrator,"",          "*Wrestling on the ground, the other kid flips Elijah and pins him down*",,],
        [narrator,"",          "*The second student unfurls Elijah's hand to reveal the action figure*",,],
        [elijahKid,,         	"Hey give that back"],
        [cody,,         	"This old thing? It belongs in the trash"],
        [narrator,"",          "*The student snaps the action figure in half and tosses it behind him*",,],
        [narrator,"",          "*Elijah cries, screams and breaks free of the hold*",,],
        [narrator,"",          "*A crowd  has gathered at this point*",,],
        //Kid 2 snaps action figure in half
        //Elijah cries, screams and breaks free of the hold
        //A crowd  has gathered at this point
        //Elijah and Kid 1 are wrestling
        //marrow runs over
        [marrow,,         	"WHAT ARE YOU DOING?? BREAK IT UP!","enter2"],
        [elijahKid,,         	"SCENE END","exit"],
        [brad,,         	"*Click to Restart","exit"],
        [cody,,         	" ","exit"],
        [marrow,,         	" ","exit"],
