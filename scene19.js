...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgPort"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",        "*A sudden jolt to the shipping container sends Elijah stumbling backwards*",,],
        [elijah,"",        "*rushes to the front and begins to open the doors*",,],
        [narrator,"",        "*Another jolt from the crane picking him up sends him swinging outwards*",,],
        [narrator,"",        "*We see flashing lights of the port and the crane lifting him*",,],
        [narrator,"",        "*Elijah is still swinging on the opened door, barely hiding from the light and guards*",,],
        [narrator,"",        "*Finally things come to a rest as the crate is placed on a shipping truck*",,],
        [narrator,"",        "*Sleepy truck driver saunters onto the screen and open the truck door*",,],
        [narrator,"",        "Another day, another delivery",,],
        [narrator,"",        "*Truck driver puts key into ignition and starts up engine with a loud rumble*",,],
        [narrator,"",        "*Truck driver adjust mirror to reveal that the shipping crate door is slightly ajar. Driver is too tired to notice*",,],
        [narrator,"",        "*Elijah sighs in relief The truck drivers begins to drive off*",,],
        [elijah,"",        "Okay I need to be quick. Let's grab this board and get out of here",,],
        [elijah,"",        "*grabs the board packaging and makes his way back to the front*",,],
        [narrator,"",        "*Driver is not driving steady*",,],
        [elijah,"",        "*A quick turn causes Elijah to stumble out of the cargo container and bang the door against the metal*",,],
        [narrator,"",        "*Driver adjusts his mirror and sees a boy*",,],
        [narrator,"",        "*Elijah is dangling onto the door and not fully on the truck anymore*",,],
        [narrator,"",        "*He has no hands free because he has the package in his other hand*",,],
        [narrator,"",        "*Truck driver overreacts, brakes, and swerves his truck*",,],
        [narrator,"",        "*The momentum causes Elijah to be flung off*",,],
        [narrator,"",        "*Elijah hits the ground and is knocked unconscious*",,],
        [elijah,"",        "*opens eyes briefly*",,],
        [elijah,"",        "*Sees lights flashing*",,],
        [elijah,"",        "*It's the police and security*",,],
        [narrator,"",        "*Elijah blacks out*",,],
        [narrator,"",        "SCENE END",,],
