...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgBasketballCourt"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [sidon,"",             "Hey Elijah, join in!","enter2","bgBasketballCourt"],
        [elijah,"",            "Sure *grumbles*","enter1",],
        [elijah,"",            "Ugh! I hate this dumb town... And this dumb orphanage... And these dumb kids",,],
        [elijah,"",            "Why does everyone keep tryin' to tell me who to be.",,],
        [elijah,"",            "Do this. Do that. Don' cha want friend?",,],
        [sidon,"",             "Watcha muttering about Eli?",,],
        [elijah,"",            "*ignores Sidon*  If he's going to shoot down every idea then I have to be creative",,],
        [elijah,"",            "I'll show them. If he won't help me, then I'll just do it myself!",,],
        [sidon,"",             "catch Eli!",,],
        [elijah,"",            "*Elijah catches the ball, dribbles and goes for the layup*",,],
        [elijah,"",            "I'm just gonna be me!",,],
        [narrator,"",          "*ball dances around rim*",,],
        [narrator,"",          "*lightning strike crashes and the ball misses, letting gravity drag it back to the ground*",,],
        [sidon,"",             "*it  begins raining and the other kids seek shelter*","exit",],
        [elijah,"",            "*Elijah stands there with the ball in his hands. Rain begins to drip down his face*",,],
        [elijah,"",            "... Gonna be me *mutters softly as he wonders what that actually means*",,],
        [elijah,"",            "*tears of frustration build. Elijah erupts and chucks the basketball at the hoop.*",,],
        [elijah,"",            "*moves to find shelter as well*",,],
        //gif of him huddled in rain across from convenience store
        [narrator,"",          " ",,"gif1"],
        [narrator,"",          "*TV ad plays* It feels great to be above it all!",,"bgRaining"],
        [elijah,"",            "Oh, it's the same jetboarder as before",,],
        [elijah,"",            "must be nice...",,],
        [elijah,"",            "*begins to daydream about the past*",,],
    ...
    function nextTextBlock() {
        ...
        else if (background != undefined && background == "bgRaining") {
            let spliceIdx = 0;
            stage.removeChildAt(spliceIdx);
            stage.addChildAt(atlas.bgRaining.default.bitmap, spliceIdx);
        }
