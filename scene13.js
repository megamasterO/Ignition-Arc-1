...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgMadMom"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",          "Elijah said that your son was antagonizing him",,"bgMadMom"],
        [narrator,"",          "There's no way my wittle Braddy Waddy would do that!",,],
        [narrator,"",          "And oh gosh, just look at his face",,],
        [narrator,"",          "This is un-accept-able!",,],
        [narrator,"",          "If anything my son is the one who was bullied. I'm pulling him out of school if nothing is done",,],
        [narrator,"",          "Did you hear how Elijah attacked that kid??",,"bgGossip"],
        [narrator,"",          "Wow that's scary!",,],
        [narrator,"",          "Yeah I would stay from him",,],
        [narrator,"",          "at the orphange",,"bgBackFromSchool"],
        [narrator,"",          "Oh you're home early from school. What happened Eli?",],
        [narrator,"",          " ",,"bgSlamDoor"],
        [narrator,"",          "SCENE END...",,],
