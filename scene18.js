...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/indietrialbeatloop.wav", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgPortEvening"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",        "BOOSTING A BOOSTER BOARD",,"bgPortEvening"],
        [narrator,"",        "*We see a ship docking on the port through the lenses of binoculars*",,],
        [narrator,"",        "*We zoom out to see a shot of Elijah in his stealth gear*",,],
        [narrator,"",        "*Elijah checks his stopwatch and glances at port time schedule*",,],
        [elijah,"neutral",     "It's almost time",],
        [elijah,"",     "Every Friday the cargo ship always arrives precisely at 8 pm",""],
        [elijah,"",     "There should be a captain and 3 crewmates",""],
        [elijah,"",     "The crewmates prep the ship for docking by undoing the bracing on the cargo and getting the anchors ready. Unless I want to pay the price I can't be seen",""],
        [elijah,"",     "After they dock they'll confirm their shipping containers with the workers at the port and unload the cargo",""],
        [elijah,,         "That's the best time to jump into action. There is usually a delay between dropping the cargo and the driver coming to pick it up",],
        [elijah,,         "But here's the catch. I need to know which shipping container will hold the goods",],
        [elijah,,         "But of course yours truly, Commander Chaos, already has that figured out. Over the weekend I snuck into the distribution center and got the list of items coming in this week",],
        [elijah,,         "Once I find the container I'll need to break in. That's where this pry bar comes in handy",],
        [elijah,,         "Using some simple mechanical advantage I can bust in easy-peasy. Mess up here though and I won't simply get off with a warning.",],
        [elijah,,         "Then all that's left is to get the goods and then get out.",],
        [elijah,,         "If everything goes well It'll be like I was never here",],
        [narrator,"",        "*some time passes*",,],
        // Elijah checks stop watch again
        [narrator,"",        "*Elijah checks stop watch again*",,],
        [elijah,,            "It's go time",,"bgPort"],
        [narrator,"",        "*Guards are doing a search of the ship with flashlights*",,],
        [narrator,"",        "*Another gaurd is reading the newspaper in the guard booth. Elijah sneaks past*",,],
        [narrator,"",        "*Elijah ducks behind a shipping container as truck lights go by*",,],
        [narrator,"",        "*One of the cranes is starting to pick up containers from the ship.*",,],
        [narrator,"",        "*Elijah moves into a better position to see*",,],
        [narrator,"",        "*We see another shipping container being lifted. Then we zoom in to see the ID*",,],
        [elijah,,            "Bingo! That's the one",],
        [narrator,"",        "*People are yelling instructions while it's being placed down*",,],
        [narrator,"",        "Where's the truck driver!?",,],
        [narrator,"",        "Just leave it here",,],
        [narrator,"",        "Get the coordinator",,],
        [narrator,"",        "*Workers rush off*",,],
        [narrator,"",        "*Elijah approaches shipping container*",,],
        //Shot 7: People are yelling instructions while it's being placed down. "Where's the truck driver!?". "Just leave it here". "Get the coordinator". People rush off
        [elijah,,            "I feel like a modern day pirate. Captain Chaos crashing in!",],
        //Shot 8: elijah pulls out his prybar and wedges it between the seal/lock
        [elijah,,            "The lock on a shipping container works like any other lock. If I place it like this and apply some pressure….",],
        [elijah,,            "*SNAP*",],
        [narrator,"",        "Who's there!?",,],
        [narrator,"",        "*Light shifts onto shipping container*",,],
        [narrator,"",        "Whoever's there come on out",,],
        [narrator,"",        "*guard peaks around the corner with his light*",,],
        [elijah,,            " ","exit"],
        [narrator,"",        "Must have been my imagination",,],
        [narrator,"",        "*Shipping container is closed and Elijah is nowhere in sight*",,],
        //Shot 9: Same bg. "Who's there!?". Light shift onto shipping container.
        //maybe show an overhead view so we know where both characters are at in relation to each other
        //Show guard walking forward. "Whoever's there come on out"
        //Show guard peaking around the corner with his light
        //Over the shoulder shot of the guard to show that it's completely empty
        //Zoomed in shot to show same shipping container ID
        //Completely black screen
        [elijah,,         "Phew. That Was close","enter1"],
        [elijah,,         "*strikes a match*",],
        //Strikes match
        [elijah,,         "Woahhh Jackpot! There's so much stuff here",],
        [elijah,,         "…Maybe too much stuff here. It'll take me a minute to sift through all of this",],
        //Maybe different shots of what he sees (if I have time to draw that much)
        [elijah,,         "Yes!! This is it!! ...",],
        //places hand over his mouth. Looks around cautiously. Sighs
        //There's a sudden jolt to the box
        [narrator,"",        "*a sudden jolt to the shipping container causes Elijah to his balance*",,],
