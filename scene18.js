...
function scriptReader() {
    ...
    var textBlocks = [
        ...
        [elijah,"",     "The crewmates sweep the deck before they arrive to make sure no pirates or stowaways have come aboard. Unless I want to pay the price I can't be seen",""],
        ...
        [elijah,,         "But of course yours truly, Commander Chaos, already has that figured out. Last week I snuck into the distribution center and the got the list of items coming in this week",],
