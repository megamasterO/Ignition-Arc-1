...
function scriptReader() {
    ...
    var textBlocks = [
        ...
        [elijah,"",          "*Elijah glances up from the corner of his eye with slight annoyance*",,],
        [bret,,     "Prolly something silly",],
        [bret,,     "That's why I'm here",],
        [bret,,     "All I did was take some product from Bridge Super Market downtown",],
        [bret,,     "Screw capitalism",],
        [bret,,     "bring down the system am-I-right?",],
        [elijah,"",          "...",,],
        [elijah,"",          " ","exit",],
        [bret,,     "...Yeah, I'll leave you alone. You prolly need to recoup",],
        [bret,,     " ","exit"],
        //later
        [rice,"",        " ","enter1","orphanage"],
        [rice,"",        "*takes off his glasses and rubs his eyes*",,],
        [rice,"",        "Okay I can do this",,],
        [rice,"",        "*Pulls out pen and paper*",,],
        [rice,"",        " ","exit",],
        //zoom to outside orphanage
        [billy,"",              "did you hear what happened to Elijah?","enter1","bgOrphanageOutside"],
        [mindy,"",             "*overhears kids talking*","enter3",],
        [anna,"",              "I heard that he's at the police station","enter2",],
        [billy,"",              "jeez what's wrong with him",,],
        [anna,"",              "I told you it would catch up with him",,],
        [anna,"",              "Nothing good comes from going against the grain. Better to fit in",,],
        [anna,"",              " ","exit",],
        [mindy,"",             "*Concern changes to determination as she marches back into the orphanage*",,],
        //transition back to jail or maybe end the scene here
        // [narrator,"",        "Later that evening",,],
        [billy,"",        "SCENE END","exit",],
        [mindy,"",        "*Click to Restart*","exit",],
