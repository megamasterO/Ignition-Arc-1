...
function scriptReader() {
    ...
    var textBlocks = [
        //PHASE 3
        [narrator,"",        "Phase 3: Gathering Tools",,"orphanage"],
        [elijah,,         "So close to the final stage!","enter1"],
        [elijah,,         "I've made things before, but mostly with a hammer, wood, and nails.",],
        [elijah,,         "This stuff is metal, and it's sealed together with stuff I haven't worked with before.",],
        [elijah,,         "I need a different kind of equipment to crack this open",],
        [elijah,,         "I think there was a few things I found in a book I read",],
        //Elijah finds book about basic tools and their uses
        [narrator,"",        "Elijah opens book about basic tools and their uses",,],
        [elijah,,         "Yeah, I know exactly where I can find this",],
        //there is a storage closet
        //In there he gets screwdrivers, an adjustable wrench and a breaker bar
        //the rest of it can only be cleaning stuff and making sure everything is tight and sealed correctly
        //He begins taking everything apart and cleaning everything
        //He's satisfied. Everything he needs is here
        //Goes to bed
        //Next day he approaches the project with enthusiasm
        [narrator,"",        "Elijah goes to storage closet",,],
        [narrator,"",        "In there he gets screwdrivers, an adjustable wrench and a breaker bar",,],
        [elijah,,         "The rest is cleaning tools to prep all my parts",],
        [narrator,"",        "Elijah begins taking everything apart and cleaning everything",,"bgOrphanageOutside"],
        [elijah,,         "Alright it looks like I have everything I need",],
        [elijah,,         "Time to go to bed",],
        [narrator,"",        "Next day he approaches the project with enthusiasm",,],
        [elijah,,         "Okay I think this goes here...and that looks about right",],
        [elijah,,         "I guess I'll tighten this bolt a little bit more",],
        [elijah,,         "Where does this part go? ...Eh, it doesn't look that important",],
        //he throws the seal to the side
        //keeps working for 3 nights
        [narrator,"",        "Elijah throws the seal to the side",,],
        [narrator,"",        "Keeps working for 3 more nights",,],
        [elijah,,         "Okay let me just tighten this and that should do it!",],
        //stands triumphantly, wiping the dirt from his brow
        [narrator,"",        "Elijah stands triumphantly, wiping the dirt from his brow",,],
        [elijah,,         "Alright let's try this out!",],
        //Elijah pulls the starter
        //nothing
        [narrator,"",        "Elijah pulls the starter",,],
        [narrator,"",        "...",,],
        [narrator,"",        "nothing happens",,],
        [elijah,,         "It probably just needs some time to warm up",],
        //tries starting it again
        //absolutely nothing
        //again
        //again
        //again
        [narrator,"",        "Elijah tries starting it again",,],
        [narrator,"",        "absolutely nothing",,],
        [narrator,"",        "again",,],
        [narrator,"",        "again",,],
        [narrator,"",        "again",,],
        [elijah,,         "C'mon work you stupid piece of junk!!",],
        //zoom out and see his montage of his attempt over and over again
        //finally gives up and stumbles inside out of tiredness and grabs a glass of water
        //drinks the water as he stares out the window at his contraption in determination
        //passes out from being so tired
        [narrator,"",        "We zoom out and see his montage of his attempt over and over again",,],
        [narrator,"",        "finally gives up and stumbles inside out of tiredness and grabs a glass of water",,],
        [narrator,"",        "drinks the water as he stares out the window at his contraption in determination",,],
        [narrator,"",        "passes out from being so tired",,],
