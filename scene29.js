...
function scriptReader() {
    ...
    var textBlocks = [
        [billy,,         "Hey guys I found something",],
        [joey,,         "What is that. It looks like a pile of junk",],
        [anna,,         "What a piece of crap. I bet Elijah built it. He's always making weird things,  especially recently",],
        [anna,,         "Let's get rid of it before he pulls another one of his pranks",],
        //All 3 kids start stomping and destroying the board
        //Elijah wakes up
        [narrator,"",        "All 3 kids start stomping and destroying the board",,],
        [narrator,"",        "Elijah wakes up",,],
        [elijah,,         "Oh crap I fell asleep","enter1"],
        //Saunters to the window
        //sees what's happening
        //Eyes widen in horror
        //rushes downstairs
        [narrator,"",        "Saunters to the window",,],
        [narrator,"",        "sees what's happening",,],
        [narrator,"",        "Eyes widen in horror",,],
        [narrator,"",        "rushes downstairs",,],
        [elijah,,         "Stop! You morons what are you doing!!",],
        [anna,,         "Try to catch us. Bleh",],
        [anna,,         "Hurry up Billy",],
        [anna,,         " ","exit"],
        [joey,,         " ","exit"],
        [billy,,         "Ib coming *pant","exit"],
        [elijah,,         "Dangit. Those Jerks! ",],
        [elijah,,         "All....All my hard work...",],
        [elijah,,         "...",],
        [elijah,,         "He's right though. Maybe this is just a pile of junk",],
        [elijah,,         "Even with all my effort I just don't have the skills or tools",],
        [elijah,,         "I have no idea what I'm doing. And it's not like one of my contraptions. This actually has to be functional",],
        [elijah,,         "All that theory and math did nothing",],
        [elijah,,         "Life isn't like a comic. There's no way I could build a fully functional booster board",],
        [elijah,,         "Whether I try hard or do nothing, it doesn't matter. I'll still fail",],
        [elijah,,         "Why'd I trick myself into believing I could get off this island",],
        //flashback to Anna saying "No one is going to adopt a weird kid like you"
        //Elijah is in a rage and crying. Kicks invention against the wall
        //It is 2 weeks before the final race starts
        [narrator,"",        "Elijah kicks invention against the wall",,],
        [narrator,"",        "Announcer: There is 2 only weeks before the race starts!",,],
