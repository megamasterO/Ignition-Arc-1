...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("sportstore"));
    ...
    Object.assign(atlas, {
        ...
        'owner': {
            default: generateCharacter("owner", 1250, 0, -1, 1, 0, 0, 0),
        },
        'knight': {
            default: {
                bitmap: knight,
...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",            "*flings open store door* *WHAM* *jingle jingle*","enter1",],
        [owner,"",             "...","enter2",],
        [elijah,"",            "Hey! I'm looking for the racing tournament sign up!",,],
        [owner,"",             "Oh boy, not this blockhead *sigh*",,],
        [owner,"",             "Settle down kid. Follow me",,],
        [owner,"",             "Did you have an adult with you?",,],
        [elijah,"",            "No sir, but I'm independent!",,],
        [owner,"",             "Of course you are",,],
        [owner,"",             "Sorry to tell you this kid, but the age requirement is 14...",,],
        [owner,"",             "*peers down over glasses* You look a little young",,],
        [elijah,"",            "Ha HA HA! I get that a lot when I shave. I actually just turned 14 a month ago!",,],
        [knight,"",            "*jingle jingle*",,],
        [owner,"",             "right -let me get this kid out of here. I've got some real customers",,],
        [owner,"",             "Well fill out this form and get it signed by an adult",,],
        [owner,"",             "Bring it back when you're finished",,],
        [elijah,"",            "Okay! I'll be back in a flash!",,],
        [owner,"",             "*under his breath* take your time",,],
        [owner,"",             "By the way, you're gonna need a jetboard. I'll be selling them",,],
        [elijah,"",            "Oh boy, this is gonna be great!",,],
        ...
        [elijah,"",            "a custom? *jingle jingle*",,],
        [elijah,"",            "I finally found something to do! Let's see what HE has to say about this *WHAM*",,],
        [owner,"",             "stop slamming the door!!",,],    
