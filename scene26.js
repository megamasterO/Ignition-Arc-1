...
function scriptReader() {
    ...
    var textBlocks = [
        ...
        [elijah,,         "I knew everything I needed but close to nothing of how it worked",],
        [elijah,,         "School didn't seem like much help, but I found a few clues at the library",,"bgLibrary"],
        [elijah,,         "In particular, a booster board manual for the new model that came out this year",],
        [elijah,,         "I was like a detective, finding bits and pieces of information anywhere I could find",],
        //Elijah is at school with an engineer book covering his actual book
        [elijah,,         "I poured over the information night and day because the deadline was fast approaching",,"bgClassroom"],
        //he's got 3 months until the deadline
        //show Elijah staring at his little chalk board in the room
        [elijah,,         "And the puzzle pieces started coming together",],
        //all the other kids gathered around (what's he doing?) maybe take this out and use for later
        //later at school
        [elijah,,         "Wait I've seen an equation like this in a book about gears F=ma",],
        //takes notes
        [elijah,,         "Hmm...interesting. That means if I rearrange it like this then…",],
        [hope,,         "Does anyone know the answer?","enter2",],
        [elijah,,         "Yeah that's going to equal to 450 N!",],
        //everyone stares in shock (No one can believe that it's Elijah speaking)
        [hope,,         "*How did he know that?? We haven't gone over that yet. In fact that's high school level physics!*",],
        [hope,,         "Um yes Elijah! There's actually no units since we were just going over the basics",],
        [hope,,         " ","exit",],
        [elijah,,         "So that's the gear ratio I'll need for my board so I know what part to look for",],
        [elijah,,         "Heh, maybe this school stuff will come in handy",],
        [narrator,"",        "We see a montage over the next couple of days. Elijah is taking notes in class, reading books, adding information to his chalkboard in the orphanage attic",,],
        [elijah,,         " ","exit"],
        //show montage of Elijah taking notes in class, reading books, adding information to his chalkboard
        //Skip forward to show parent-teacher conference
        [hope,,        "Welcome in to the parent-teacher conference Mr. Rice ^Oh he's kind of cute^","enter1",],
        [rice,,        "Good evening. I hope none of my kids are causing any trouble, especially Elijah","enter2",],
        [hope,,         "Not at all. Actually, we've noticed a drastic change in Elijah's behavior. He's been clinging on to every word I say",],
        [hope,,         "And he has been performing significantly better. Of course he's far from being the best student",],
        [hope,,         "frequent miscalculations, interrupting the class with answers, but his comprehension is quite remarkable",],
        [rice,,         "*Sigh* I am so glad to hear. Is there anything I can do to keep this up",],
        [hope,,         "You mean you haven't been helping already?? He knows stuff that we don't teach until much later",],
        [rice,,         "No... I mean... I guess I knew he was going to the library",],
        [rice,,         "*scratches his head*",],
        //scratches his head
        [hope,,         "Well don't worry, even though he's still weak in language studies and history he hasn't been causing any trouble for the other teachers",],
        [hope,,         "We've all been really surprised. Mrs. Snudi still can't get over it",],
        [hope,,         "Well keep up the good work",],
        [hope,,         "That is all","exit"],
        //later at home
        [elijah,,         " ","enter1","orphanage"],
        [rice,,         "Hey Eli",,],
        ...
        [rice,,         " ","exit",],
        [elijah,,         "sure sure *Elijah is focused on his work and barely hears Mr. Rice*",,],
