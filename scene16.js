...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgPrincipalOffice"));
...
function scriptReader() {
    ...
    let screenLayers = {
        Front_1: {
            char: rice, //top-levl object holding all emotions
            emotion: "default", //tells us which emotion we are dealing with
            mask: rice.default.mask //retrieves the mask value
        },
        Front_2: {
            char: dupaul,
            emotion: "default",
            mask: dupaul.default.mask
        },
        Back_1: {
            char: elijah,
            emotion: "default",
            mask: elijah.default.mask
        },
        Back_2: {
            char: joey,
            emotion: "default",
    ...
    var textBlocks = [
        [dupaul,"",  "I have reason to believe that Elijah is Commander CHAOS!",],
        [rice,,     "who?",],
        [dupaul,"",  "clears throat* commander chaos. It's a moniker",""],
        [rice,"",          "I don't know what that is sir",],
        [dupaul,"",  "Maybe Elijah here can explain",],
        [elijah,"",            "...",],
        //Elijah shrugs as if to say why are you looking at me
        [dupaul,"",  "Fine. Well about the past year I've been seeing vandalism with the letters CC painted around school.",],
        [dupaul,"",  "And what's more is that these letters only appear when something strange happens.",],
        [dupaul,"",  "I have deduced that those letters mean Commander Chaos",],
        //show shot of the graffiti tag with an explanation right below it "CC= commander chaos"
        [rice,"",          "What kinda strange things are we talking about?",],
        //[dupaul,"",  "Well for example! One time I was thinking real hard in my office and I placed my---",],
        //import gif here
        //show scene of him to take off his toupee to scratch his head
        //claws come in to snatch it off desk and is replaced with a sticker of "CC"
        [dupaul,"",  "For example, last Friday I thought I saw Elijah running through the halls and it turned out to be nothing but a broom and a soccer ball taped to a remote control car",],
        [rice,"",          "*clears throat in an attempt to hold back a chuckle*",],
        //trying to hold back laughter
        [rice,,     "Eli, are you commander chaos?",],
        [elijah,,         	"noooo I have no idea what he's talking about"],
        [dupaul,"",  "Don't you play dumb with me. I'm onto YOU",""],
        [rice,,     "not to deny what you're saying but do you have any evidence?",],
        [dupaul,"",  "Well no, but it's written all over his face. Just look at him",""],
        //Elijah making puppy dog eye's/face
        [elijah,,         	" ",,"gif1"],
        [rice,,     "I don't want to say this. But is this a rac---",],
        [dupaul,"",  "GAH! Of course not. Huff. Nevermind. Just make sure he's doing his homework and stuff. It's getting chaotic around here so I don't want him falling behind",""],
        [dupaul,"",  "Also I'm letting all parents know I'm implementing a few new initiatives here. Of course to keep the children safe and engaged in learning",],
        [dupaul,"",  "We'll have a resource officer stationed at all times and local authority on our hotline. For the safety of course. I've heard that other schools have been getting bomb threats.",],
        [dupaul,"",  "We want to make sure there's no disruptions to learning around here",],
    //glares at Elijah
        [narrator,"",          "SCENE END",,],
