...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/hallway.png", id: "bgimage" },
...
function scriptReader() {
    ...
    var textBlocks = [
        // in the hallway
        // I think it'll be interesting to see all the gear and tools in his hands. We need to make this cool. This is the first bit of engineering
        [elijah,"",            "Well that went mostly to plan.","enter1"],
        [elijah,"",            "Step 1 is complete. Getting out of class.",],
        [elijah,"",            "Typically teachers send students down to the principal's office if they get in trouble.",],
        [elijah,"",            "It's a way to instill fear and intimidation so we do exactly as they say.",],
        [elijah,"",            "But, before seeing Principal Dupaul I have an additional stop to make along the way.",],
        [elijah,"",            "*pulls out screwdriver and duct tape*",,],
        [elijah,"",            "And in the end I'll cause so much chaos that they will forget all about my earlier stunt",],
        //pan to bathroom
        // [elijah,"",            "And not that they deserve it but I'm giving all the students a free pass to get out of this cage.",],
        [elijah,"",            "If school is a prison then the only right thing to do is have a prison break!",],
        [elijah,"",            "Some might call me a hero, but I prefer... Commander Chaos!",],
        [elijah,"",            "Honestly, this might be my biggest prank yet!",],
