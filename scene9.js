...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("orphanageoutside"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",            "*Fuming, Elijah storms out of the orphanage and walks past an adult couple*","enter1",],
        [narrator,"",            "*all the other kids are outside playing*",,],
        [billy,"",             "Well look if it ain't a-li-ar!","enter2",],
        [joey,"",              "Pffft...That's a good one cuz it sounds like his real name E-li-jah. Hehehe","enter4",],
        [billy,"",             "I know right! I was up all night thinking up that one. Heh",,],
        [elijah,"",            "Outta my way Billy",,],
        [billy,"",             "Huh...what are YOU gonna do?",,],
        [elijah,"",            "*Brushes Past Billy and Joey*",,],
        [joey,"",              " ","exit",],
        [anna,"",              "No one's ever gonna adopt a moody kid like you","enter4",],
        [mindy,"",             "Hey, leave Elijah alone!","enter3",],
        [billy,"",             "Oh shut your trap Mindy",,],
        [elijah,"",            "Listen...I don't care. Who needs parents anyway? Adults are booooring.",,],
        [elijah,"",            "They only tell you what to do and give you chores. I'm gonna do what I want to do!",,],
        [elijah,"",            " ","exit",],
        [billy,"",             "That brat. He thinks he's sooooo tough",,],
        [mindy,"",             " ","exit",],
        [anna,"",              " ","exit",],
        [billy,"",             " ","exit",],
