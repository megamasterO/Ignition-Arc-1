...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/elijahHurt.png", id: "elijah" },
        ...
        { src: "sounds/quietslumber.mp3", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgJailCell"));
...
function scriptReader() {
    ...
    var textBlocks = [
        [elijah,"",          "*punches wall, slides down, and begins sitting on floor next to the comics*","enter1","bgJailCell"],
        [elijah,"",          "*His eyes glance over, still in a daze*",,],
        [elijah,"",          "*reaches out to grab the comic*",,],
        [elijah,"",          "I've read these comics so many times",,],
        [elijah,"",          "*Elijah flips to the first page*",,],
        [elijah,"",          " ","exit","bgComic"],
        [electriclady,,     "I didn't have a normal childhood","enter1"],
        [electriclady,,     "Based on my circumstances I mutated. I don't like the term mutant because the kids think it's cool like the X-men",],
        [electriclady,,     "My circumstances were anything but cool",],
        //We get to see Electric Lady and Atomic Gentle building and attempting to get off planet earth
        [electriclady,,     "Atomic Gentle and I have been on plenty of adventures",],
        [electriclady,,     "But I still remember the start of it all. Leaving planet earth",],
        [electriclady,,     "It's laughable how many times we failed",],
        [electriclady,,     "But that became the corner stone of our philosophy",],
        [electriclady,,     "Never give up. No matter what!",],
        [electriclady,,     " ","exit","bgJailCell"],
        //We see them break through the earth's outer atmosphere and gravitational pull that keeps them orbiting
         
        [elijah,,         "Pshht. Never give up. I don't have anything left to give up","enter1"],
        [elijah,,         "I couldn't get off this island even with all the effort I've put into it",],
        [narrator,,     "*The sun begins to dip down past sunset with the last rays of sunlight peaking through the window bars*",],
        [narrator,,     "*It's quiet*",],
        [narrator,,     "*Darkness falls over the room*",],
        [narrator,,     "*Faint clanging noises that grow steadily louder can be heard echoed throughout the detention center*",],
        [narrator,,     "*Elijah glances over to his door with slight curiosity*",],
        [narrator,,     "*It sounds like it's coming from the cell right across from his*",],
        [narrator,,     "*click*",],
        [narrator,,     "*All of a sudden a spark erupts followed by a burning fire*",],
        [narrator,,     "*A face emerges from the darkness*",],
        [engineer,,     "I thought I heard someone give up","enter2"],
        [engineer,,     "But listen, anything's possible with engineering",],
        [engineer,,     "You don't need much",],
        [engineer,,     "Just an ignition",],
        [narrator,,     "*Grin is noticeable in the light*",],
        [narrator,,     "*Pulls out cigar and lights it*",],
        [narrator,,     "*Takes a long draw*",],
        [engineer,,     "Take this lighter for example",],
        [engineer,,     "Made with nothing but stuff lying around and some creativity",],
        [engineer,,     "The only thing that will hold you back in engineering is not working hard enough",],
        [engineer,,     "I'm sure if I just stuck to my guns a little harder, my daughter would still be here with me...",],
        [engineer,,     "Don't get accustomed being here, being stuck",],
    
        //This is a trigger than sparks something in Elijah
        [elijah,,         "Wait say that again",],
        [engineer,,     "Don't get accustomed being here?",],
        [elijah,,         "A-custom-ed...",],
        [elijah,,         "A custom!!",],
        [engineer,,     "*flashback to kids in shop talking about building a custom jet board*","exit","sportstore"],
        [narrator,"",          "customer 1: What are you getting?",,],
        [narrator,"",          "customer 2: My dad and I are gonna build a custom. It will be 100 times cooler and probably cheaper!",,],
        [elijah,,         "I don't need rocket science. I just need the parts!",,"bgJailCell"],
