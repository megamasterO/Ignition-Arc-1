...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/arcadespace.mp3", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("orphanage"));
...
function scriptReader() {
    ...
    var textBlocks = [
        //Phase 2 (slides onto the screen and slides off)
        [narrator,"",        "Phase 2 slides onto the screen and then slides off",,"orphanage"],
        [elijah,,         "It's time to source the materials for my booster board","enter1"],
        [narrator,"",        "Elijah is putting on his stealth gear",,],
        [elijah,,         "Ok all set",],
        [elijah,,         " ","exit"],
        [mindy,,         "Where is he going?","enter2"],
        [mindy,,         " ","exit","bgJunkyard"],
        [elijah,,         "*sneaks to the junkyard*","enter1"],
        [elijah,,         "*throws bag over fence and hops over too*",],
        [elijah,,         "*lands and makes a bunch of noise*",],
        [narrator,"",        "Pan over to see guard still fast asleep",,],
        [elijah,,         "Phew, that was a close one",],
        [elijah,,         "*turns around*",],
        [elijah,,         "*dogs are right in his face*",],
        [elijah,,         "Ack, I gotta get out of here!",],
        //He's badly beat up and his clothes are torn (luffy-esque face when nami punches him)
        [elijah,"",        "Elijah is on fence and dogs are right behind him","exit",],
        [narrator,"",        "Woof woof! Scratch. Owwwww. GRrrrrr",,],
        [elijahHurt,,         "Tomorrow I'll get revenge","enter1"],


        [elijahHurt,"",        "The next night","exit",],
        [narrator,"",        "Elijah has a bat and a baseball",,],
        [elijah,,         "This time I'm prepared","enter1"],
        [elijah,,         "*climbs fence*",],
        [elijah,,         "*lands silently*",],
        [elijah,,         "*throws ball to distract the dogs*",],
        [elijah,,         "*sneaks past*",],
        [elijah,,         "*starts digging around*",],
        [elijah,,         "*he finds the item*",],
        [narrator,"",     "At the same time dogs find him",,],
        [elijah,,         "...Crap","exit"],
        [narrator,"",        "Woof woof! Scratch. Owwwww. GRrrrrr",,],
        //next scene shows him beat up again
        [elijahHurt,,         "At least I got what I needed","enter1"],
        //Next day
        [elijahHurt,,         "Next day",,"orphanage"],
        [anna,,         "What's going on with Elijah's face?","enter2"],
        [billy,,         "He's probably getting in fights again. That little punk","enter4"],
        [anna,,         "And he prolly can't win since he's so scrawny",],
        [anna,,         "Elijah is ignoring them and walks out for school with bandages everywhere","exit"],
        [billy,,         " ","exit"],
        [elijahHurt,,         "I've got to find a way to deal with those dogs",],
        //That night
        [narrator,,         "That night",,"bgJunkyard"],
        //montage starts
        //playing peek a boo with the dogs by peaking around the corner and ducking back in
        //next scene is a straight on shot of him beat up
        //Elijah tries to trick them with a homemade scarecrow doll of himself
        //dogs look like they are about to fall for it, but realize and attack the real person
        //straight shot of Elijah beat up
        //dresses up and pretends to be a dog
        //still beat up
        [narrator,,         "montage starts",,],
        [narrator,,         "playing peek a boo with the dogs by peaking around the corner and ducking back in",,],
        [narrator,,         "He gets mauled",,],
        [narrator,,         "Next, Elijah tries to trick them with a homemade scarecrow doll of himself",,],
        [narrator,,         "dogs look like they are about to fall for it, but realize and attack the real Elijah",,],
        [narrator,,         "straight on shot of him beat up",,],
        [narrator,,         "Elijah dresses up and pretends to be a dog",,],
        [narrator,,         "Dogs begin to play with him but ended up getting to rough",,],
        ...
        [elijahHurt,,       "*feeds the dogs*",],
        //feeds the dogs
        [elijahHurt,,     "Okay I'm coming over now",],
        [narrator,,         "Elijah climbs over the fence and the dogs don't attack",,],
        [narrator,,         "Elijah walks forward and the dogs follow",,],
        [narrator,,         "Elijah is digging through things with dogs by his side and a flashlight in his mouth",,],
        [narrator,,         "*Timelapse begins*",,],
        [narrator,,         "The sun goes up and down multiple times and we see Elijah junk pile grow",,],
        [narrator,,         "Elijah hops over the fence for the last time",,],
        [elijah,,         "Alright that should do it","enter1"],
        //covers everything with a piece of cloth

        [elijahHurt,"",        "SCENE END","exit",],
        [elijah,"",        "*Click to Restart*","exit",],
        //scene ends   
    ];
