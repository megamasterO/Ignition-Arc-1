...
function init() {
    ...
    let manifest = [
        ...
        { src: "sounds/afteresquesShort.mp3", id: "bgmusic" },
...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgBurgerBills"));
...
function scriptReader() {
    ...
    var textBlocks = [
        //The following will be a series of panning scenes
        //Scene begins with us inside the restaurant. We can't see much
        //Door open to reveal Mr. Rice
        //Elijah is peaking out from behind him with excitement in his eyes
        //Expand scene to reveal interior of restaurant
        //It is colorful with music and a jukebox and arcade cabinets
        //Show Elijah ecstatic to be in restaurant
        //Shot of Elijah jumping into the air with a fist pump
        //shot of Elijah eagerly looking at arcade games with child like wonder
        //shot of Elijah and Mr. Rice ordering food
        //Shot of Elijah dancing (he's got on a birthday hat and has the blowout noise-maker toy)
        //”My name is zoom and I live on the moon! I came down to earth just to sing you this tune! HAPPY BIRTHDAY”
        //later on...
        //Shot to show that Elijah is full and party-ed out
        //He's slumped over in his booth seat with ketchup and fries on his face and clothes
        //Mr. Rice taps him on the shoulder
        //enter scene
        [rice,,         "*Door swings open to reveal Mr. Rice","enter2"],
        [elijah,,         "*Elijah is peaking out from behind him with excitement in his eyes*","enter4"],
        [narrator,"",        "The inside of the restuarant is colorful with a music jukebox and arcade cabinets",,],
        [narrator,"",        "Elijah is ecstatic to be here",,],
        [narrator,"",        "He jumps into the air with a fist pump",,],
        [narrator,"",        "We see a shot of Elijah eagerly looking at arcade games with child like wonder",,],
        [narrator,"",        "Then a shot of Elijah and Mr. Rice ordering food",,],
        [narrator,"",        "Another shot of Elijah dancing with a birthday hat and a blowout noise-maker toy",,],
        [narrator,"",        "Birthday song is playing -My name is zoom and I live on the moon!",,],
        [narrator,"",        "I came down to earth just to sing you this tune! HAPPY BIRTHDAY",,],
        [narrator,"",        "Later on...",,],
        [narrator,"",        "Elijah is full and party-ed out",,],
        [narrator,"",        "He's slumped over in his booth seat with ketchup and fries on his face and clothes",,],
        [rice,,         "*Mr. Rice taps him on the shoulder*",],
        [rice,,         "Hey I have something to give you",],
        [elijah,,         "ehhhh",],
        [elijah,,         "*Elijah is still half asleep*",],
        //Elijah is still half asleep
        [rice,,         "When you were dropped off at my door steps I knew there was something special about you",],
        [rice,,         "You were smiling and giggling",],
        [rice,,         "Like you were content and had no worries on your mind",],
        [rice,,         "Being young and innocent is a beautiful thing",],
        // [rice,,         "You know exactly who you are",],
        [rice,,         "You're not yet shackled by other people's expectations and can remain true to yourself and your own curiousity",],
        [rice,,         "...",],
        [rice,,         "I don't know who your parents are but-",],
        [rice,,         "*Mr. Rice unravels a piece of cloth to reveal a key in its sheath*",],
        //Mr. Rice unravels a piece of cloth to reveal a key in its sheath
        [rice,,         "I was given this key and a note that instructed to pass it onto to you when you turned 10",],
        [rice,,         "I was hesitant in showing you today. I myself don't know what it means and who it is from.",],
        [rice,,         "I thought maybe it would give you doubts or make you confused of where you belong, but I'm confident you will find out what it means and what it's for",],
        [elijah,,         "Is it from my parents?",],
        [rice,,         "I don't know, but it's yours now",],
        [rice,,         "*Mr. Rice wraps key around Elijah's neck as a necklace*",],
        //Mr. Rice wraps key around Elijah's neck as a necklace
        [rice,,         "Happy Birthday Elijah",],
        [rice,,         "Always know that you are special and loved",],
        [rice,,         "*Fades back into present time*","exit"],
        //fades back into present time
