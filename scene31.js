...
function scriptReader() {
    ...
    var textBlocks = [
        ...
        //Elijah is tapping his chewed up pencil in anticipation
        //Tests are passed out
        //Elijah starts working through problems with ease
        //You can see a look of determination and focus in his eyes
        //However, everytime the reader gets to take a look at the test the numbers are rearranged on the paper
        //Elijah finished test and turns it in
        //Later at the orphanage
        [narrator,"",        "Day of the test",,"bgClassroom"],
        [narrator,"",        "scene fades in from black",,],
        [elijah,"",        "Elijah is tapping his chewed up pencil in anticipation","enter1",],
        [narrator,"",        "Tests are passed out",,],
        [narrator,"",        "Elijah starts working through problems with ease",,],
        [narrator,"",        "You can see a look of determination and focus in his eyes",,],
        [narrator,"",        "However, everytime we take a look at the test the numbers are rearranged on the paper",,],
        [narrator,"",        "Elijah finished test and turns it in",,],
        [narrator,"",        "Later at the orphanage",,"orphanage"],
        [rice,,         "how'd it go?","enter2"],
        [elijah,,         "I aced it!",],
        [elijah,,         "*Elijah gives Mr. Rice thumbs up*",],
        [rice,,         "*Mr. Rice smiles back*",],
        [rice,,         " ","exit"],
        //Elijah gives Mr. Rice thumbs up
        //Mr. Rice smiles back
        //The next day at school
        [narrator,"",        "The next day at school",,"bgClassroom"],
        [teacher,,         "Before I give the tests back, I want to say that I'm impressed with how well everyone did!","enter2"],
        [elijah,,         "*Elijah is beaming*",],
        //Elijah is beaming
        [teacher,,         "There were 3 perfect scores this time",],
        //Elijah thinks to himself “Ooo one of those is probably me”
        [elijah,,         "^Ooo one of those is probably me^",],
        [teacher,,         "When I call your name come up and pick up your test",],
        [teacher,,         "Sally",],
        [teacher,,         "Virginia",],
        [teacher,,         "Grant",],
        [teacher,,         "Congrats on your perfect tests. Keep up the good work",],
        [teacher,,         "I'll hand out the rest. There were lots of A's as well",],
        [teacher,,         "Michael, Suzie, Johnny, James, Tim, Kathy, Karen... Jill",],
        //Fear begins to build as it's taking so long to get to him
        [elijah,,         "*fear begins to creep over his face",],
        [teacher,,         "Jill, you did ok but make sure to carry over numbers",],
        [teacher,,         "Elijah",],
        //Elijah walks to forward of room
        //Teacher passes Elijah his test
        [elijah,,         "*Elijah walks to front of room*",],
        [elijah,,         "*Teacher passes Elijah his test*",],
        [teacher,,         "It's clear you haven't been paying attention in class. I'll have a word with you later Elijah",],
        //Elijah and reader see what's written on the test
        //Red marks are everywhere
        //F- in bold is circled at the top of the page
        //A note written at the top ”Don't just guess at answers”
        //Elijah body trembles as he holds back tears
        [narrator,"",        "Elijah and reader see what's written on the test",,],
        [narrator,"",        "Red marks are everywhere",,],
        [narrator,"",        "F- in bold is circled at the top of the page",,],
        [narrator,"",        "A note written at the top -Don't just guess at answers-",,],
        [narrator,"",        "Elijah's hands begin to tremble as he holds back tears",,],
        [elijah,,         "I... gotta use the restroom",],
        //Elijah runs out of room
        [elijah,"",        "Elijah runs out of room","exit",],
        [teacher,"",        "SCENE END","exit",],
