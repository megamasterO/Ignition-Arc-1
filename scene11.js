...
function handleComplete(event) {
    ...
    var startingBackground = new createjs.Bitmap(loader.getResult("bgClassroomOld"));
...
function scriptReader() {
    ...
    var textBlocks = [
        //Zoom into 2nd grade math class
        [narrator,"",     "*Enter flashback*",,],
        [marrow,,         	"Does anyone have the answer?","enter2",],
        //Elijah raises his hand enthusiastically and waves it
        [elijahKid,,         	"Oooooo me","enter1",],
        [marrow,,         	"Go ahead"],
        [elijahKid,,         	"It's 24!"],
        [marrow,,         	"Mmmmm not quite. Your close though"],
        [marrow,,         	"Why don't we turn the rest of the class into a study hall so you guys can work on these practice problems"],
        [marrow,,         	" ","exit"],
        [narrator,,        	"Students begin to work on homework",],
        [narrator,,        	"Elijah erases his answer and begins to work on it again",],
        [students,,         "*giggling*","enter3"],
        //elijahKid looks from the corner of his eye and keeps working
        [students,,         "*whispering* how many is that?"],
        [students,,         "I think I can fit one more"],
        //Elijah feels something brush along his scalp
        [elijahKid,,         	"Hey what are you guys doing?"],
        [elijahKid,,         	"*as Elijah turns around and reaches up to his head a whole heap of pencils fling out*"],
        [elijahKid,,         	"What the-?"],
        [students,,         "run for it!","exit"],
        //kids running away
        [elijahKid,,         	"Hey get over here!"],
        //Elijah chases after classmates
        //teacher turns around from board
        [marrow,,         	"Elijah! NO running in class. And don't chase after your classmates!","enter2"],
        [marrow,,         	"I'm gonna have to send you down to the Principal's office"],
        [elijahKid,,        "But they jus-"],
        [marrow,,         	"Uh uh no excuses Elijah"],
        [marrow,,         	"Down you go",],
        [marrow,,         	" ","exit"],
        //at the Principal's office
        [dupaul,,         "I heard you were causing a distraction in class. We have a ZERO tolerance policy here.","enter2"],
        [dupaul,,         "This time will be a warning. But keep up this behavior and I will have to suspend you buddy"],
        [dupaul,,         " ","exit"],
        [elijahKid,,        "^It was at that moment that I realized that life wasn't about fairness..."],
        [elijahKid,,        "It was about what you can get away with"],
        [elijahKid,,        "So I decided to toughen up a bit^"],
        [narrator,,         "click to restart","exit"],
