...
function scriptReader() {
    ...
    var textBlocks = [
        [rice,"",         "*knock knock*","enter3","orphange"],
        [rice,"",         "Elijah, they're here",,],
        [elijah,"",       "*Elijah looks up*",,],
        [greg,"",         "*Greg enters*","enter4",],
        [suzzane,"",      "*Suzzane enters*","enter2",],
        [suzzane,"",      "Whatcha got there?",,],
        [elijah,"",       "*brushes comics under bed and only leaves homework out*",,],
        [elijah,"",       "Just working on school stuff",,],
        [suzzane,"",      "*Suzzane looks at Greg*",,],
        [suzzane,"",      "Oh how nice",,],
        [suzzane,"",      "Well we just wanted to introduce ourselves",,],
        [suzzane,"",      "My name is Suzzane and this is my husband Greg",,],
        [greg,"",         "Hey champ",,],
        [greg,"",         "So uh, we hear you like reading",,],
        [elijah,"",       "Yeah, comics",,],
        [suzzane,"",      "Oh... Well isn't that just lovely Greg",,],
        [suzzane,"",      "I know you don't know much about us  but we live down by Blake and 3rd Avenue",,],
        [suzzane,"",      "We are members of Saint Baptist III church and we just want to give back to the community and help children like you...",,],
        [greg,"",         "Well in a SITUATION like yours",,],
        [elijah,"",       "Okayy...",,],
        [suzzane,"",      "Well dear I think that's about all aha",,],
        [suzzane,"",      "Just wanted to pop in and say hi",,],
        [suzzane,"",      "We'll be seeing you again very soon",,],
        [elijah,"",       "...",,],
        [elijah,"",       " ","exit",],
        [rice,"",         " ","exit","bgOrphanageOutside"],
        [suzzane,"",      "Oh heavens. Did you see how many comics he had??",,],
        [suzzane,"",      "No wonder he's having trouble focusing in school",,],
        [greg,"",         "Too many distractions",,],
        [suzzane,"",      "I'm surprised Mr. Rice allows that",,],
        [greg,"",         "You can't blame him. He can't control that many kids in his house. He has been coming to church recently too",,],
        [suzzane,"",      "Well this will be good for him. We have a perfect home environment that will give him the tutelage and encouragement he needs",,],
        [greg,"",         "Indeed this is the Lords work that brought us to him",,],
        [greg,"",         "This boy will be a reverent man before long",,],
        [greg,"",        "SCENE END","exit",],
        [suzzane,"",        "*Click to Restart*","exit",],
        //scene ends   
    ];
