...
function init() {
    ...
    let manifest = [
        ...
        { src: "images/captain.png", id: "captain" },
...
function handleComplete(event) {
    ...
    Object.assign(atlas, {
        ...
        'captain': {
            default: generateCharacter("captain", 0, 0, 1, 1, 0, 0, 0),
        },
        'knight': {
            default: {
                bitmap: knight,
...
function scriptReader() {
    ...
    var textBlocks = [
        [narrator,"",        "*police detention cell slides closed*",,],
        [elijah,"",          "*...*",,],
        [elijah,"",        "*Elijah closes eyes*","exit",],
        [narrator,"",        "*Screen fades into a flashback*",,],
        [elijahKid,"",          " ","enter2","bgClassroomOld"],
        [cindy,"",          " ","enter4",],
        [rachael,"",          "My parents are taking me to the Caribbean Islands for vacation this year.","enter1",],
        [rachael,"",          "It's going to a cruise ship with a buffet, swimming pools, and games. I'm so pumped!",,],
        [cindy,"",          "Yeah me too, I'm going to do something similar.",,],

        [elijahKid,"",          "I want to go on a vacation too!",,],
        [elijahKid,"",          "I've never been anywhere before. I wonder if I could go",,],
        [narrator,"",        "*other students look in shock that Elijah has spoken*",,],
        [rachael,"",          "Ohh haha...",,],
        [rachael,"",          "I think you'd have to ask your parents",,],
        [elijahKid,"",          "I don't have any parents",,],
        [rachael,"",          "Well... maybe when you do?",,],
        [elijahKid,"",          "That's ok, I'll just go by myself",,],
        [narrator,"",        "*other kids look at each other with nervousness and concern*",,],
        [cindy,"",          "Oh yeah, I guess that's possible?","exit",],
        [rachael,"",          " ","exit",],
        [elijahKid,"",          "^that's right, there's a ship that comes here. I'll just get on that",,],
        [elijahKid,"",          "^as soon as I'm not grounded and done with detention",,],
        [elijahKid,"",          " ","exit",],
        [elijahKid,"",          " ","enter1","bgPortEvening"],
        [narrator,"",        "A month passes by",,],
        [narrator,"",        "Elijah is sitting gleefully aboard the cargo deck ready to depart on his new adventure",,],
        [captain,"",        "Hey you! You can't be here","enter2",],
        [captain,"",        "Security!",,],
        [captain,"",        " ","exit",],
        [rice,"",        " ","enter2","orphanage"],
        [rice,"",        "What were you thinking Elijah?? You can't leave here by yourself. Who would protect you",,],
        [narrator,"",        "*Elijah stares off into the distance*",,],
        [rice,"",        "I mean are you even thinking about these things?? And not only that...",,],
        [narrator,"",        "Mr. Rice keep talking while Elijah listens with blank eyes",,],
        [elijahKid,"",          " ","exit",],
        [rice,"",        " ","exit",],
        [narrator,"",        "A few days later. Elijah is laying in the attic reading his comic books",,],
        [elijah,"",  "Electric Lady and Atomic Gentle are cool names. I need something like that",""],
        [elijah,"",  "Hmmm",""],
        [elijah,"",  "Electric Lady, Atomic Gentle… and… Commander Chaos!",""],
        [elijah,"",  "I want to show what it's like not having control over your own life",""],
        [elijah,"",  "I want to give a taste of what freedom's like",""],
        [narrator,"",        "SCENE END",,],
        [narrator,"",        "*Click to Restart*",,],
        [elijah,"",          " ","enter1","bgJailCell"],
        //scene ends   
    ];
